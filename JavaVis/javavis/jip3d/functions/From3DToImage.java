 ...
 */
public class From3DToImage extends Function3D {

	Vector3D o;
	Point3D reference;
	String filename;

	public From3DToImage() {
		super();
	...
	public void proccessData(ScreenData scr_data) throws JIPException {
		...
		progress = 0;
		double prog_inc;
		//This minimum param is used to avoid odd values in the image space. Although this 
		//param should be an input one, here is given manually. It's set to work with sick 
		//laser 3D images (up to 80 m.)
		double minimum = 3;
